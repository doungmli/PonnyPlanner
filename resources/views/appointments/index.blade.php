                                ...
                                @if(request('show') == $appointment->id)
                                    <div class="mt-3">
                                        <form action="{{ route('appointments.assign') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <!-- Première Colonne: Sélection des poneys -->
                                                <div class="col-md-6">
                                                    <label>Assigner des poneys :</label>
                                                    <select name="ponies[]" multiple class="form-control" size="4">
                                                        @foreach($ponies as $pony)
                                                            <option value="{{ $pony->id }}">{{ $pony->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <!-- Deuxième Colonne: Sélection des employés -->
                                                <div class="col-md-6">
                                                    <label>Assigner des employés :</label>
                                                    <select name="employees[]" multiple class="form-control" size="4">
                                                        @foreach($employees as $employee)
                                                            <option value="{{ $employee->id }}">{{ $employee->last_name }} {{ $employee->first_name }}</option>
                                                        @endforeach
                                                    </select>
...
@endsection
--}}
// DERNIERE UPDATE EN DESSOUS
{{--@extends('layouts.app')--}}

{{--@section('content')--}}
{{--    <div class="container-fluid">--}}
{{--        <h1 class="display-4 text-center my-4">Gestion Journalière</h1>--}}
...
{{--                    <h2>{{ \Carbon\Carbon::now()->locale('fr')->translatedFormat('l d F Y') }}</h2>                    <div class="appointments">--}}
...
{{--                                                                @foreach($ponies as $pony)--}}
{{--                                                                    <option value="{{ $pony->id }}" @if(in_array($pony->id, $appointment->ponies->pluck('id')->toArray())) selected @endif>{{ $pony->name }}</option>--}}
{{--                                                                @endforeach--}}
{{--                                                            </select>--}}
{{--                                                        </div>--}}
{{--                                                    @endfor--}}
